...
public class GiftCardsDetailsPage extends Baseclass {
	...
	/************* To return gift message box *************/
	public static WebElement giftMessageBox() {
		return driver.findElement(giftMessage);
	}
	...
	/************* To return recipient name *************/
	public static WebElement recipientNameBox() {
